package com.ufo.ccphotopaint.fab;
...
public class FloatingActionsMenu extends ViewGroup {
    ...
    private void createAddButton(Context context) {
        ...
        setAddButtonIcon(mAddButtonIcon);
    ...
    public void setAddButtonIcon(int icon) {
        mAddButton.setIcon(icon);
    }

    public void setAddButtonIconDrawable(@NonNull Drawable iconDrawable) {
        mAddButton.setIconDrawable(iconDrawable);
    }

    public void setAddButtonColor(int colorNormal, int colorPressed) {
        mAddButtonColorNormal = colorNormal;
        mAddButtonColorPressed = colorPressed;
