package com.ufo.ccphotoview.fragment;
...
import com.ufo.ccphotoview.adapter.CCPhotoPagerAdapter;
 ...
 */
public class CCImagePagerFragment extends Fragment {
    ...
    private CCPhotoPagerAdapter mPagerAdapter;
    ...
    public void setCCPhotoViewLisenter(CCPhotoViewLisenter ccPhotoViewLisenter) {
        ...
        if (mPagerAdapter != null) {
            mPagerAdapter.setCCPhotoViewLisenter(mCCPhotoViewLisenter);
        }

    }


    public static CCImagePagerFragment newInstance(List<String> paths, int currentItem) {

        CCImagePagerFragment f = new CCImagePagerFragment();
    ...
    public static CCImagePagerFragment newInstance(List<String> paths, int currentItem, int[] screenLocation, int thumbnailWidth, int thumbnailHeight) {

        CCImagePagerFragment f = newInstance(paths, currentItem);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mPagerAdapter = new CCPhotoPagerAdapter(Glide.with(this), paths);
    }
    ...
    private void runEnterAnimation() {
        ...
        ObjectAnimator colorizer = ObjectAnimator.ofFloat(CCImagePagerFragment.this,
                "saturation", 0, 1);
    ...
    public void runExitAnimation(final Runnable endAction) {
        ...
        ObjectAnimator colorizer =
                ObjectAnimator.ofFloat(CCImagePagerFragment.this, "saturation", 1, 0);
        colorizer.setDuration(duration);
        colorizer.start();
    }
